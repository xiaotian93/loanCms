$(function(){
    ...
    if(getUrlParam("listId")!=null){
        $(".update").each(function(i,obj){
            ...
            if($(obj).attr("total_ptype")==getUrlParam("listId")){
                $(obj).addClass("active");
            }
        });
    }
    ...
    $('.input-group-btn').click(function(){
        ...
        datas.listId=$(".active.update").attr("total_ptype");
        base.data_conn("v2/cms/product/list/data",datas,productLists,"get");
    });
    //获取贷款产品列表
    var list={};
    list.listId=$(".active.update").attr("total_ptype");
    $(".update").click(function(){
        var changeList={};
        changeList.listId=$(this).attr("total_ptype");
    ...
    $("#sortable").on("click",".delP",function(){
        ...
        function delProduct(e){
            if(e.code==0){
                ...
                if(searchVal==''){
                    //alert(1)
                    base.data_conn("v2/cms/product/list/data?listId="+$(".active.update").attr("total_ptype"),"",productList,"get");
                }else{
                    //alert(2)
                    var datas={};
                    datas.title=searchVal;
...
//    贷款产品定时
    ...
    $(".timeSure").click(function(){
        ...
        form.append("listId",$(".active.update").attr("total_ptype"));
...
//新增列表数据
    $("#btn2").click(function(){
        window.location="addList.html?listId="+$(".active.update").attr("total_ptype")+"&ptype="+$(".active.update").attr("ptype");
    })
});